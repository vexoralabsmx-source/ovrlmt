...
export default function Home() {
  return <PageFrame>
    ...
    <section className="featured section-pad">
      <div className="section-head"><div><p className="section-label">02 / GARMENT SYSTEM</p><h2>DROP 001</h2></div><p>AFTER DARK<br />LIMITED RELEASE</p></div>
    ...
    <section className="timeline section-pad">
      <p className="section-label">03 / ORIGIN SYSTEM</p>
