...
export default function SizeGuide() { return <PageFrame>
  <section className="page-hero size-hero"><p className="eyebrow">GARMENT SYSTEM / FIT DATA</p><h1>SIZE<br />GUIDE</h1><div className="page-intro"><p>OVERSIZED BY DESIGN.<br />MEASURED IN CENTIMETERS.</p><span>GS/01 — UNISEX</span></div></section>
  <section className="size-section section-pad"><Reveal><div className="size-note"><span>FIT NOTE / 001</span><p>Las prendas tienen fit oversized. Si prefieres un ajuste más normal, considera elegir una talla menos.</p></div></Reveal>
