  ...
  return (
    <PageFrame>
      ...
      <section className="page-hero drop-hero">
        ...
        <h1>
          OVRLMT STORE<span>— CATÁLOGO ACTIVO</span>
        </h1>
        <div className="page-intro">
          <p>
            Playeras sobre pedido.
            <br />
            Drops y piezas de edición limitada.
          </p>
          <span>HECHO PARA TI — OVRLMT</span>
        </div>
      </section>
      ...
      <HowToBuy />
      <section className="custom-design section-pad">
        <div>
          <p className="section-label">04 / HECHO PARA TI</p>
          <h2>
            ¿TIENES UNA IDEA?
            <br />
            <em>LA HACEMOS PLAYERA.</em>
          </h2>
        </div>
        <div className="custom-design-copy">
          <p>También realizamos diseños personalizados. Cuéntanos tu idea, referencias, colores y talla para comenzar tu pedido.</p>
          <Link className="btn primary" href="/contact?piece=custom-design">
